                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="header-bottom" style="margin-top: 60px;">
                                <div class="logoHeader" style="margin-bottom: 40px;">
                                    <div class="header-bottom_left" style="float: left; position: relative;">
                                        <p  class="flexing"> <span class="invoice-color">Name
                                                :</span>{{ $client_name }}</p>
                                    ...
                                    <div class="header-bottom_right" style="float: right; position: relative;">
                                        {{-- <div class="darkcolor"></div>
                                        <div class="darkcolor"></div> --}}
                                        <p class="flexing justify-content-end"><span class="invoice-color">Date:
                                            </span>{{ $invoice_month }}</p>
                                    </div>

                                </div>
                            </div>
                        </header>
                        <div class="d-flex justify-content-between align-item-center mb-3 gap-3">

                            <div class="border border-secondary-subtle rounded p-3 w-50">
                        ...
                        <table class="invoice-table">
                            ...
                            <tbody>
                                <tr style="">
                                    <td style="text-align: center; border:1px solid #c7c7c7">{{ $client_name }}</td>
                                    <td style="text-align: center; border:1px solid #c7c7c7">{{ $invoice_description }}</td>
                                    @if ($invoice_profit != '')
                                        <td style="border:1px solid #c7c7c7">{{ $invoice_profit }}</td>
                                    @endif
                                    <td style="text-align: center; border:1px solid #c7c7c7">${{ $invoice_amount }}</td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="logoHeader">
                            ...
                            <table class="total-table" style="width: 350px;">
                                <tr>
                                    <th style="font-weight: 600; color:#fca311; font-size:18px;">Sub Total</th>
                                    <td style="color: gray; font-size:18px;">{{ $invoice_amount }}</td>
                                </tr>
                                {{-- <tr>
                                ...
                                <tr>
                                    <th style="font-weight: 600; color:#14213d; font-size:22px;">Total</th>
                                    <td style="color: gray; font-size:22px;">${{ $invoice_amount }}</td>
                                </tr>
                            </table>
