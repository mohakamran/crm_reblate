                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="/register-login-access/{{ $emp_login_code }}">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td>Employees</td>
                                    <td><input type="checkbox" id="emp_check_all" name="emp_access[]" value="all"></td>
                                    <td><input type="checkbox" id="emp_check_view" name="emp_access[]" value="view"></td>
                                    <td><input type="checkbox" id="emp_check_create" name="emp_access[]" value="create"></td>
                                ...
                                <tr>
                                    <td>Expenses</td>
                                    <td><input type="checkbox" id="expenses_check_all" name="expenses_access[]" value="all"></td>
                                    <td><input type="checkbox" id="expenses_check_view" name="expenses_access[]" value="view"></td>
                                    <td><input type="checkbox" id="expenses_check_create" name="expenses_access[]" value="create"></td>
                                ...
                                <tr>
                                    <td>Clients</td>
                                    <td><input type="checkbox" id="clients_check_all" name="clients_access[]" value="all"></td>
                                    <td><input type="checkbox" id="clients_check_view" name="clients_access[]" value="view"></td>
                                    <td><input type="checkbox" id="clients_check_create" name="clients_access[]" value="create"></td>
                                ...
                                <tr>
                                    <td>Invoices</td>
                                    <td><input type="checkbox" id="invoices_check_all" name="invoices_access[]" value="all"></td>
                                    <td><input type="checkbox" id="invoices_check_view" name="invoices_access[]" value="view"></td>
                                    <td><input type="checkbox" id="invoices_check_create" name="invoices_access[]" value="create"></td>
                                ...
                                <tr>
                                    <td>Salary Slips</td>
                                    <td><input type="checkbox" id="salary_slip_check_all" name="salary_slip_access[]" value="all"></td>
                                    <td><input type="checkbox" id="salary_slip_check_view" name="salary_slip_access[]" value="view"></td>
                                    <td><input type="checkbox" id="salary_slip_check_create" name="salary_slip_access[]" value="create"></td>
