                            ...
                            <div class="d-flex flex-column h-100 py-0 py-xl-3">
                                ...
                                <div class="card my-auto overflow-hidden">
                                    <div class="row g-0" style="min-height: 530px; ">
                                        <div class="col-lg-6  d-flex align-items-center justify-content-left p-5"  style="backdrop-filter: blur(5px); background-color: #F1F2F3;">
                                                ...
                                                <form method="post" action="/client-login" class="auth-input">
                                                    ...
                                                    <div class="mb-2 d-flex inputboxcolor mb-3 form-control @error('employee_code') is-invalid @enderror" style="border: 1px solid #14213d; border-radius:50px; background-color: white;">
                                                        ...
                                                        <input id="text" type="email"
                                                            ...
                                                            name="client_email" value="{{ old('client_email') }}" style="border: none; margin-left: 10px; background-color:transparent; outline: none;width:100%"
                                                    ...
                                                    <div class="form-check mb-1 ms-3">
                                                        ...
                                                        <label style="color: #14213d;" for="showPassword">Show Password</label>
                                                    ...
                                                    <div class="form-check d-flex justify-content-between">
                                                        <div class="ms-3">
                                                            ...
                                                            <label class="form-check-label" style="color: #14213d" for="remember">Remember
                                                                me</label>
                                                        </div>
                                                        <a href="/forget-password" class="text-end" style="color: #fca311">Forget Password?</a>
                                                    </div>
                                        ...
                                        <div class="col-lg-6" style="backdrop-filter: blur(5px); background-color: #14213d;">
                                            <div class="px-5 pt-3">
                                                <div class="">
                                                    <h1 class="reblateText mb-0 pt-4" style="color: #fca311; font-size: 60px;">Client</h1>
                                                    <h1 class="reblateSubText my-0" style="color: #fff">Login Detail</h1>
                                                </div>

                                                <div class="stylingImage d-flex justify-content-center">
                                                    <img class="stylingImagePic" src="{{ url('clientLogoFront.png') }}" alt="Employee Logo">
                                                </div>
                                            </div>
                                            <a href="/login" class="go-back"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="#fca311" d="m4 10l-.707.707L2.586 10l.707-.707zm17 8a1 1 0 1 1-2 0zM8.293 15.707l-5-5l1.414-1.414l5 5zm-5-6.414l5-5l1.414 1.414l-5 5zM4 9h10v2H4zm17 7v2h-2v-2zm-7-7a7 7 0 0 1 7 7h-2a5 5 0 0 0-5-5z"/></svg> Go Back</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card -->
