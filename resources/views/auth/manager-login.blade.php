                                    ...
                                    <div class="row g-0" style="min-height: 530px; ">
                                        <div class="col-lg-6 d-flex align-items-center justify-content-left p-5"
                                            ...
                                            <div class="d-flex flex-column " style="width: 80%">
                                                <h1 class="reblateText mb-0" style="color: #fca311;font-size: 42px">Welcome Back !</h1>
                                                ...
                                                <form method="post" action="/manager-login" class="auth-input">
                                                    ...
                                                    <div class="mb-2 d-flex inputboxcolor mb-3 form-control @error('employee_code') is-invalid @enderror" style="border: 1px solid #14213d; border-radius:50px; background-color: white;">
                                                        ...
                                                        <input id="text" type="text"
                                                            ...
                                                            style="border: none; margin-left: 10px; background-color:transparent; outline: none;width:100%" placeholder="Emp Code"
                                                            maxlength="8">
                                                        @error('employee_code')
                                                    ...
                                                    <div class="mb-3 d-flex form-control inputboxcolor @error('user_password') is-invalid @enderror" style="border: 1px solid #14213d; border-radius:50px; background-color: white;">
                                                        ...
                                                        <input type="password"
                                                            ...
                                                            style="border: none; margin-left: 10px; background-color:transparent; outline: none;width:100%" name="user_password"
                                                    ...
                                                    <div class="form-check d-flex justify-content-between">
                                                        <div class="ms-3">
                                                            ...
                                                            <label tyle="color: #14213d" class="form-check-label" for="remember">Remember
                                                                me</label>
                                                        </div>
                                        ...
                                        <div class="col-lg-6" style="backdrop-filter: blur(5px); background-color: #14213d;">
                                            ...
                                            <div class="px-5 pt-3" >
                                                ...
                                                <div class="">
                                                    <h1 class="reblateText mb-0 pt-4" style="color: #fca311; font-size: 60px;">Manager</h1>
                                                    <h1 class="reblateSubText my-0" style="color: #fff">Login Detail</h1>
                                                </div>

                                                <div class="stylingImage d-flex justify-content-center">
                                                    <img class="stylingImagePic" src="{{ url('managerLogoFront.png') }}" alt="Employee Logo">
                                                </div>
