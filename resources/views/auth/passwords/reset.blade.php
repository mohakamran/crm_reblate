                                    ...
                                    <div class="row g-0" style="min-height: 530px; ">
                                        <div class="col-lg-6 d-flex align-items-center justify-content-left p-5"
                                            ...
                                            <div class="d-flex flex-column " style="width: 80%">
                                                <h1 class="reblateText mb-0" style="color: #fca311;font-size: 40px">Update
                                                    Password !</h1>

                                                <form method="post" action="/password-update" class="auth-input">
                                                    @csrf
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        @error('user_type')
                                                            <span style="color:#ED5E49;">Please select a user!</span>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="mb-2 d-flex inputboxcolor mb-3 form-control @error('email') is-invalid @enderror" style="border-radius:50px; background-color: white;">
                                                    ...
                                                    <div class="mb-2 d-flex inputboxcolor mb-3 form-control @error('confirm_password') is-invalid @enderror" style=" border-radius:50px; background-color: white;">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M2 17h20v2H2zm1.15-4.05L4 11.47l.85 1.48l1.3-.75l-.85-1.48H7v-1.5H5.3l.85-1.47L4.85 7L4 8.47L3.15 7l-1.3.75l.85 1.47H1v1.5h1.7l-.85 1.48zm6.7-.75l1.3.75l.85-1.48l.85 1.48l1.3-.75l-.85-1.48H15v-1.5h-1.7l.85-1.47l-1.3-.75L12 8.47L11.15 7l-1.3.75l.85 1.47H9v1.5h1.7zM23 9.22h-1.7l.85-1.47l-1.3-.75L20 8.47L19.15 7l-1.3.75l.85 1.47H17v1.5h1.7l-.85 1.48l1.3.75l.85-1.48l.85 1.48l1.3-.75l-.85-1.48H23z"/></svg>
                                                        <input id="password" type="password"
                                                        style="border: none; margin-left: 10px; background-color:transparent; outline: none;width:100%"
