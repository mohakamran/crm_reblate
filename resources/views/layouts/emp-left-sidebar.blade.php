    ...
    <div data-simplebar class="vertical-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                @if(Session::get('attendance_access') != 'none' || Session::get('employees_access') != 'none' || Session::get('attendance_access') != 'none' || Session::get('tasks_access') != 'none')
                ...
                @endif
                                ...
                                <!-- finance -->
                @if(Session::get('invoices_access') != 'none' || Session::get('salary_slips_access') != 'none' || Session::get('salary_slips_access') != 'none')
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
