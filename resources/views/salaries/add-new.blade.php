                        ...
                        <form method="post" action="{{ $route }}" enctype="multipart/form-data">
                            <div class="row ">
                                <div class="col-md-6 col-xl-6">
                                    <h3 style="font-size: 30px; padding-bottom: 10px; border-bottom: 1px solid #e3e3e3;">Employee Details</h3>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 inputboxcolor">
                                                <input class="form-control" style="background-color: transparent; border:none;" type="text" placeholder="email"
                                                    name="emp_code" disabled value="{{ $emp->Emp_Code }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 inputboxcolor">
                                                <input class="form-control" style="background-color: transparent; border:none;" type="text" placeholder="User Name"
                                                    name="emp_designation" disabled value="{{ $emp_date_of_joining }}"
                                                    min="0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 inputboxcolor">
                                                <input class="form-control" style="background-color: transparent; border:none;" type="text" placeholder="email"
                                                    name="emp_shift_time" disabled value="{{ $emp_month_salary }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 inputboxcolor">
                                                <input class="form-control" style="background-color: transparent; border:none;" type="text" placeholder="User Name"
                                                    name="emp_designation" disabled value="{{ $emp->Emp_Designation }}"
                                                    min="0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 inputboxcolor">
                                                <input class="form-control" style="background-color: transparent; border:none;" type="text" placeholder="email"
                                                    name="emp_shift_time" disabled value="{{ $emp->Emp_Shift_Time }}">
                            ...
                            <div class="col-md-6 col-xl-6">
                                <h3 style="font-size: 30px; padding-bottom: 10px; border-bottom: 1px solid #e3e3e3;">Salary Details</h3>
                                <div class="row form-group">
                                    <div class="col-md-3 col-sm-12">
                                        <label required class=" col-form-label">Basic Salary</label>
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" type="number" name="emp_basic_salary"
                                            min="0" id="basicSalary" onchange="calculateSalary()" value="0">

                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <label for="example-text-input" required class=" col-form-label">KPI Bonus</label>
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" type="number" name="emp_kpi_bonus" min="0"
                                            id="kpiBonus" onchange="calculateSalary()" value="0">

                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <label required class=" col-form-label">Project Bonus</label>
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" type="number" name="emp_project_bonus"
                                            min="0" id="projectBonus" onchange="calculateSalary()"
                                            value="0">

                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <label required class=" col-form-label">Designation Bonus</label>
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" type="number" id="emp_designation_bonus"
                                            name="emp_designation_bonus" min="0" id=""
                                ...
                                <div class="form-group  row">
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <label for="example-text-input" required class=" col-form-label">Absent
                                            Days</label>
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" type="number" name="emp_absent" min="0"
                                            value="0">

                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <label required class=" col-form-label">Travel Allowence</label>
                                        <input class="form-control inputboxcolor" min="0" id="emp_travel_allowence"
                                            name="emp_travel_allowence" style="background-color: #e3e3e3; border:none;" type="number" onchange="calculateSalary()"
                                            value="0">
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <label required class=" col-form-label">Leave Days</label>
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" min="0" name="emp_leave" type="number"
                                            value="0">
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <label for="example-text-input" min="0" required
                                            class=" col-form-label">Deduction</label>
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" type="number" value="0" name="emp_deduction"
                                            min="0" id="deduction" onchange="calculateSalary()">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-3 col-sm-12">
                                        ...
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" type="number" value="0"
                                            name="emp_no_of_working_days" min="0" id="">

                                    </div>
                                    <div class="col-md-9 col-sm-12">
                                        <label required class=" col-form-label">Reason of Deduction</label>

                                        <textarea class="form-control inputboxcolor"  rows="5" name="emp_reason_deduction" style="resize: none; height:15px; background-color: #e3e3e3; border:none;" placeholder=""></textarea>
                                        <br>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" type="number" name="emp_total_salary" disabled
                                            min="0" id="totalSalary" value="0">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" type="number" name="emp_deduction" disabled
                                            min="0" id="displayDeduction" value="0">
                                        <input type="hidden" name="emp_deduction_hidden" id="emp_deduction_hidden">
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label required class=" col-form-label">Net Salary</label>
                                        <input class="form-control inputboxcolor" style="background-color: #e3e3e3; border:none;" type="number" name="emp_net_salary" disabled
                                            min="0" id="netSalary" value="0">
