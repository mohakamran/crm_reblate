...
<head>
    ...
    <title>{{ $emp_name }} Salary for Month {{$emp_month_salary_hidden}} </title>
...
<div class="container">
    {{-- <img src="https://reblatesols.com/assets/reblate_dark-5ab25660.png" alt="logo" class="logo"> --}}
    ...
    <table >
        <tr height="100px" class="heading" style="">
            <td colspan='4' style="padding:10px;font-size:17px;">Employee Details</td>
        </tr>
        <tr>
            <th>Name</th>
            <td>{{ $emp_name }}</td>
...
<div class="contact_section">
    ...
    <p><strong>Website:</strong> <a style="color:black;font-size:13px;" href="https://reblatesols.com"> https://reblatesols.com </a></p>
