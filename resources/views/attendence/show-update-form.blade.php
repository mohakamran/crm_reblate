                            ...
                            @if (session('success'))
                                <div class="container-fluid d-flex justify-content-end">
                                    <div class="alert alert-success alert-dismissible fade show d-flex justify-content-between align-items-center"
                                        style="max-width: 300px;" id="close-now">
                                        {{ session('success') }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating mb-3 inputboxcolor">
                                        <input class="form-control" style="background-color: transparent; border:none;"
                                            ...
                                            value="{{ isset($index->check_in_time) ? ($index->check_in_time ? date('H:i', strtotime($index->check_in_time)) : '') : old('check_in_time') }}"
                                            min="00:00" max="23:59">
                                        @error('check_in_time')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating mb-3 inputboxcolor">
                                        <input class="form-control" style="background-color: transparent; border:none;"
                                            ...
                                            value="{{ isset($index->check_out_time) ? ($index->check_out_time ? date('H:i', strtotime($index->check_out_time)) : '') : old('check_out_time') }}"
                                            min="00:00" max="23:59">

                                        @error('check_out_time')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        <label for="check_out_time">Check Out Time <span
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating mb-3 inputboxcolor">
                                        <input class="form-control" style="background-color: transparent; border:none;"
                                            ...
                                            value="{{ isset($index->break_start) ? ($index->break_start ? date('H:i', strtotime($index->break_start)) : '') : old('break_start') }}"
                                            min="00:00" max="23:59">
                                        @error('break_start')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating mb-3 inputboxcolor">
                                        <input class="form-control" style="background-color: transparent; border:none;"
                                            ...
                                            value="{{ isset($index->break_end) ? ($index->break_end ? date('H:i', strtotime($index->break_end)) : '') : old('break_end') }}"
                                            min="00:00" max="23:59">
                                        @error('break_end')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
