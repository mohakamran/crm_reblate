                                ...
                                <table class="table custom-table table-nowrap mb-0">
                                    <thead>
                                        <tr style="background-color: #14213d20">
                                            <td class="p-3 font-size-16 EmpStyle" style="color: #14213d;font-weight: 600"
                                            ...
                                            @php
                                                for ($count = 1; $count <= $numberOfDaysInMonth; $count++) {
                                                    echo '<td class="p-3 font-size-16 EmpStyle" style="color: #14213d;font-weight: 600">' .
                                                        $count .
                                                        '</td>';
                                                }
                                            @endphp
                                    ...
                                    <tbody id="myTable">
                                        @foreach ($emp as $employee)
                                            <tr style="border-bottom: 1px solid #c7c7c7">
                                                <td class="EmpStyle font-size-12"
                                                    style="text-align: center; padding:15px;color: #14213d;font-weight: 600">
                                                    {{ $employee->Emp_Code }}
                                                </td>
                                                ...
                                                @foreach ($daysOfMonth as $day)
                                                    <td style="text-align: center;">
                                                        ...
                                                        @if (isset($datesForMonth) && $datesForMonth != null)
                                                            ...
                                                            @endphp
                                                            @if ($isHoliday)
                                                                <span title="Holidays" class="text-white rounded-pill"
                                                                    style="padding: 5px 8px;background-color: #0D6EFD">H</span
                                                            ...
                                                            @elseif ($dayName == 'Saturday' || $dayName == 'Sunday')
                                                                <div class="vertical-text " style="margin-left: 10px;">
                                                                    <span title="Weekend" class="text-white rounded-pill"
                                                            ...
                                                            @elseif ($leaveRecord && $leaveRecord->status == 'approved')
                                                                ...
                                                                <span title="Leave" class="text-white rounded-pill"
                            ...
                            <div class="card" style="box-shadow: none;">
                                <div class="card-body" style="border:1px solid #c7c7c7">
                                    ...
                                    <table class="table table-nowrap table-responsive">
                                        ...
                                        @if ($total_leaves && $total_leaves->isNotEmpty())
                                        @foreach ($total_leaves as $present)
                                            <tr>
                                                <td style="padding:10px; font-weight:600;color:#14213d">
                                                    {{ $present->emp_code }}</td>
                                                <td style="padding:10px; font-weight:600;color:#14213d">
