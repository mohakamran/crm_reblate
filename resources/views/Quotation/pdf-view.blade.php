    ...
    <div class="row container-fluid">
        <div class="col-12">
            <div class="p-3">
                ...
                <div class="row quotation-container">
                    <div class="row">
                        <div class="col-md-6  ">
                            <div class="box">
                                ...
                                </svg> <a href="https://www.reblatesols.com"
                                    style="color:black;">www.reblatesols.com</a></p>
                            </div>
                ...
                <div class="">
                    <div class="row">
                        ...
                        <div class="col-md-6 "
                            style="font-family: 'Poppins', sans-serif;display: flex;flex-direction: column;justify-content: flex-end;align-items: flex-end;">
