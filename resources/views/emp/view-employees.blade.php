                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <div class="d-flex gap-3">
                                                <a href="/update-employee/{{ $emp->Emp_Code }}" data-toggle="tooltip" class="btn btn-success btn-sm"
                                                    data-original-title="Edit">
                                                    <i class="mdi mdi-pencil"></i>
                                                     <a href="javascript:void()" onclick="deleteEmployee('{{ $emp->Emp_Code }}')" class="btn btn-danger btn-sm"
